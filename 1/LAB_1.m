...
resahped_data = reshape(QPSK_data,[16, 4]);
...
SNR_mat = -4:20;
received_signal_mat = zeros(72, length(SNR_mat));
...
for j=1:length(SNR_mat)
    ...
    data_out_1 = r(1: Block_size + CyclicPrefix_size);
    
    data_out_2 = r(Block_size + CyclicPrefix_size + 1 : 2*(Block_size + CyclicPrefix_size));
    
    data_out_3 = r(2*(Block_size + CyclicPrefix_size)+1 : 3*(Block_size + CyclicPrefix_size));
    
    data_out_4 = r(3*(Block_size + CyclicPrefix_size)+1 : 4*(Block_size + CyclicPrefix_size));
    
    data_block_out_1 = data_out_1(CyclicPrefix_size + 1 : Block_size + CyclicPrefix_size);
    data_block_out_2 = data_out_2(CyclicPrefix_size + 1 : Block_size + CyclicPrefix_size);
    data_block_out_3 = data_out_3(CyclicPrefix_size + 1 : Block_size + CyclicPrefix_size);
    data_block_out_4 = data_out_4(CyclicPrefix_size + 1 : Block_size + CyclicPrefix_size);
